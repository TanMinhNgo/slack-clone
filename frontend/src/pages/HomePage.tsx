...
const HomePage = () => {
  ...
  useEffect(() => {
    if (chatClient) {
      ...
      if (channelId) {
        const channel: any = chatClient.channel("messaging", channelId);
        setActiveChannel(channel);
        console.log("Set active channel to", channelId);
      }
    }
    console.log("Chat client or search params changed");
      ...
      <Chat client={chatClient}>
        <div className="chat-container">
          ...
          <div className="str-chat__channel-list">
            <div className="team-channel-list">
              ...
              <div className="team-channel-list__content">
                ...
                {/* CHANNEL LIST */}
                <ChannelList
                  filters={{ members: { $in: chatClient?.user?.id ? [chatClient.user.id] : [] } }}
          ...
          <div className="chat-main">
            <Channel channel={activeChannel as any}>
              <Window>
                <CustomChannelHeader />
                <MessageList />
                <MessageInput />
